...
router.post('/', (0, auth_1.default)('admin'), fileParser_1.parser.array('images', 10), car_utils_1.convertAddCarReq, (0, validateRequest_1.default)(car_validation_1.CarValidations.createCarValidation), car_controller_1.CarController.createCar);
router.get('/featured', car_controller_1.CarController.getRandomCars);
